...
class Parser:
    ...
    def set_arguments(self):
        ...
        ### Dataset
        self.parser.add_argument('--data', type=str, default="ZINC", choices=["ZINC"], help='dataset type')
        ...
        self.parser.add_argument('--edge-ratio', type=float, default=0.15, help='pooling ratio for edges')
